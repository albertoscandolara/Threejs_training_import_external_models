...
export default class IvyPlant {
  constructor(object, index) {
    ...
    const ivyPlantVariableName = `${MODEL_CONSTS.ivyPlants.prefix}${index
      .toString()
      .padStart(3, "0")}`;
    this.properties = MODEL_CONSTS.ivyPlants[ivyPlantVariableName];
